          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Run the onboarding command in your terminal to create a
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Answer a few questions about your goals and experience
                      level
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      AI analyzes the codebase and selects the most important
                      files for you
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Return here for a voice-guided tour through your
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Talk to your AI guide. Ask questions naturally and get contextual
              answers.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Understand architecture, dependencies, and gotchas without asking
              teammates.
            </p>
          </div>
        </div>
